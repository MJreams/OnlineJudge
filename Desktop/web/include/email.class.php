...
class Smtp
{
    ...
    /* Constractor */
    function __construct($relay_host = "", $smtp_port = 465,$auth = true,$user,$pass)
    {
        $this->debug = FALSE;
    ...
    function sendmail($to, $from, $subject = "无标题", $body = "", $mailtype, $cc = "", $bcc = "", $additional_headers = "")
    {
